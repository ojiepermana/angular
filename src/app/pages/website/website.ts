...
@Component({
  ...
  template: `
    <div class="space-y-24">
      <!-- Hero Section -->
      <section class="text-center py-16 bg-gradient-to-br from-muted/50 to-accent/10 rounded-2xl border border-border">
        ...
        <div class="flex gap-4 justify-center flex-wrap">
          ...
          <a href="https://github.com/ojiepermana/angular" target="_blank" class="px-8 py-3 rounded-lg no-underline font-semibold transition-all duration-200 bg-secondary text-secondary-foreground border-2 border-border hover:bg-primary hover:text-primary-foreground hover:-translate-y-0.5">GitHub Repository</a>
        </div>
      </section>
      ...
      <section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="p-8 bg-card rounded-2xl shadow-md border border-border">
      ...
      <section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="p-8 bg-card rounded-2xl shadow-md transition-transform duration-200 hover:-translate-y-1 border border-border">
      ...
      <section>
        ...
        <div class="flex flex-col gap-4 max-w-4xl mx-auto">
          <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center items-start gap-2 p-4 bg-card rounded-lg shadow-sm border border-border">
      ...
      <section class="text-center">
        ...
        <div class="bg-muted text-muted-foreground p-4 rounded-lg mb-4 overflow-x-auto border border-border">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
          <div class="text-left">
            ...
            <div class="bg-muted text-muted-foreground p-4 rounded-lg overflow-x-auto border border-border">
...
import {{ '{' }} ThemeService {{ '}' }} from '@ojiepermana/angular/services';</code></pre>
        ...
        <!-- Development Info -->
        <div class="bg-card p-6 rounded-xl border border-border text-left max-w-4xl mx-auto">
