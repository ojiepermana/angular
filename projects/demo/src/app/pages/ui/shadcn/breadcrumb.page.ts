      ...
      <section class="mb-10">
        ...
        <nav ui-breadcrumb>
          <ol ui-breadcrumb-list>
            <li ui-breadcrumb-item><a ui-breadcrumb-link [routerLink]="'/v'">Home</a></li>
            <li ui-breadcrumb-separator></li>
            <li ui-breadcrumb-item><a ui-breadcrumb-link [routerLink]="'/v/ui/shadcn/button'">Components</a></li>
            <li ui-breadcrumb-separator></li>
