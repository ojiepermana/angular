...
@Component({
  ...
  template: `
    <div class="layout min-h-screen bg-background p-0 text-foreground md:p-4">
      <div
        class="layout-content relative mx-auto flex min-h-screen w-full flex-col overflow-hidden border border-border bg-background text-foreground shadow-sm md:min-h-[calc(100vh-2rem)] md:rounded-4xl"
